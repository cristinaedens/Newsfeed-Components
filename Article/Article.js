...
function newsCreator(articleTitle, articleDate, paragraphOne, paragraphTwo, paragraphThree) {
    //create the elements
...
//set forEach
data.forEach((data) => {
    articleHolder.append(newsCreator(data.title, data.date, data.firstParagraph, data.secondParagraph, data.thirdParagraph));
})